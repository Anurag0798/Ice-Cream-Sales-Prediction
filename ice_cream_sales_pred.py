...
collection = db['ice_cream_sales_pred'] # Create a new collection/table in the database

def load_model():
    with open('ice_cream_sales_final_model.pkl', 'rb') as f:
        poly_model2 = pickle.load(f)
...
def main():
    ...
    st.write("Enter the temperature to get a prediction for your Ice Cream Sales (units)")
